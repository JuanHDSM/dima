...
namespace Finux.Api.Migrations
{
    ...
    [Migration("20260604211317_CreateRecurringTable")]
    partial class CreateRecurringTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Finux.Core.Models.Recurring", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.Property<sbyte?>("Installments")
                        .HasColumnType("TINYINT")
                        .HasColumnName("installments");

                    b.Property<sbyte>("InstallmentsType")
                        .HasColumnType("TINYINT")
            ...
            modelBuilder.Entity("Finux.Core.Models.Transaction", b =>
                {
                    ...
                    b.HasOne("Finux.Core.Models.Recurring", "Recurring")
                        .WithMany()
